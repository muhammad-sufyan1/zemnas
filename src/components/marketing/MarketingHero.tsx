    ...
    <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-primary">Growth Marketing</span>
        </div>
        ...
        >
          ...
          <br />
          <span className="text-muted-foreground">consistency, not quick wins.</span>
        </h1>
        ...
        >
          We design and manage digital marketing systems that support long-term demand, 
