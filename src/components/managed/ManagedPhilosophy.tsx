...
const lines = [
  "Managed services are about continuity, not control.",
  "We support teams by maintaining, improving, and adapting systems over time.",
  "You focus on your work. We handle the infrastructure.",
];

export const ManagedPhilosophy = () => {
